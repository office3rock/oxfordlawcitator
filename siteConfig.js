module.exports = {
  siteUrl: "https://oxfordlawcitator.com", // Site domain. Do not include a trailing slash!

  postsPerPage: 12, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

  siteTitleMeta: "oxfordlawcitator", // This allows an alternative site title for meta data for pages.
  siteDescriptionMeta:
  ...
  shortTitle: "oxfordlawcitator", // Used for App manifest e.g. Mobile Home Screen
  siteIcon: "favicon.png", // Logo in /static dir used for SEO, RSS, and App manifest
  backgroundColor: "#e9e9e9", // Used for Offline Manifest
  themeColor: "#15171A", // Used for Offline Manifest
  apiUrl: "https://reshet.jetdomains.co.il/oxfordlawcitator",
  subscribeWidget: {
    visible: false,
    title: "oxfordlawcitator",
  ...
  header: {
    navigation: [
      {
        label: "Homepage",
        url: "https://oxfordlawcitator.com/",
      },
      {
        label: "Contact",
        url: "https://oxfordlawcitator.com/contact",
      },
    ],
  },
  footer: {
    ...
    navigation: [
      ...
      {
        label: "Sitemap",
        url: "https://oxfordlawcitator.com/sitemap.xml",
      },
